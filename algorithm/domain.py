...
# Entry Point
def mmmn_domain(user_input: np.ndarray, category: str, file_name: str) -> None:
    ...
    match file_type:
        case True:
            return process_img(user_input, CONFIG, category, file_name)
        case False:
            return process_video(user_input, CONFIG, category, file_name)
        case _:
...
def process_img(img: np.ndarray, CONFIG, category, file_name) -> dict:
