...
def extractResampling(spectrum: np.ndarray) -> None:
    ...
    resample_extaction = {
        "std_resample": round(periodicity, 4),
        "resampled": periodicity
        
    }

    return resample_extaction
